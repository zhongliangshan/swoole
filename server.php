...
define('SWOOLE_LOG', SWOOLE_PATH.'/log');
define('SWOOLE_TASK_PID_PATH', SWOOLE_PATH . DIRECTORY_SEPARATOR . 'log' . DIRECTORY_SEPARATOR . 'swoole-task.pid');
define('SWOOLE_TASK_NAME_PRE', 'swoole-OneThing_Alarm');

// 加载一些常用的函数
require_once SWOOLE_PATH . '/Functions/functions.php';
